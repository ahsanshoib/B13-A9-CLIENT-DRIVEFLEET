  ...
  return (
    <PrivateRoute>
      <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        <h1 className="text-2xl sm:text-3xl font-extrabold text-center text-[#8b1a1a] mb-6 sm:mb-10">
          MY ADDED CARS
        </h1>
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {cars.map((car) => (
              <div
                key={car._id}
                className="bg-white rounded-2xl p-4 sm:p-5 shadow-sm border border-yellow-200 flex items-center gap-4"
              >
                {/* Car Image */}
                <div className="relative w-24 h-20 sm:w-28 sm:h-20 rounded-xl overflow-hidden flex-shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-bold text-gray-900 text-sm sm:text-base">{car.name}</p>
                  <p className="text-xs text-gray-400 font-semibold tracking-wide mt-1.5">CAR DESCRIPTION</p>
                ...
                <div className="flex flex-col sm:flex-row gap-2 flex-shrink-0">
                  <button
                    ...
                    className="bg-orange-400 hover:bg-orange-500 active:scale-95 text-white text-xs sm:text-sm font-bold px-4 py-2 rounded-full transition-all"
                  >
                    Edit
                  </button>
                  <button
                    onClick={() => setDeleteModal({ open: true, id: car._id })}
                    className="bg-[#8b1a1a] hover:bg-red-900 active:scale-95 text-white text-xs sm:text-sm font-bold px-4 py-2 rounded-full transition-all"
                  >
                    Delete
                  </button>
                </div>
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl">
            ...
            <div className="space-y-3 max-h-[60vh] overflow-y-auto pr-1">
              {["name", "price", "type", "location", "image"].map((field) => (
                <div key={field}>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm mt-1 focus:outline-none focus:border-orange-400"
                  />
                </div>
              ))}
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm mt-1 resize-none focus:outline-none focus:border-orange-400"
                />
              </div>
            </div>
            ...
            <div className="flex gap-3 mt-5">
              <button
                ...
                className="flex-1 bg-orange-400 hover:bg-orange-500 text-white font-bold py-2.5 rounded-xl transition-colors"
              >
                Save Changes
              </button>
              <button
